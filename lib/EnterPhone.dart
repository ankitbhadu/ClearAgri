...
class _EnterPhoneState extends State<EnterPhone> {
  final _val=new TextEditingController();
  @override
    ...
    return new Scaffold(
      body: Column(
        ...
        Padding(
          ...
          child: RaisedButton(
            onPressed: () {
  Mobile =_val.text.toString().trim();

            print('$Mobile');
              Navigator.of(context).push(new MaterialPageRoute(
                  builder: (context) => new PhoneAuthSimple2(

                countryCode: '+91',
                phoneNumber: _val.text.toString().trim(),
...
class PhoneAuthSimple2 extends StatefulWidget {
  ...
  @override
  _PhoneAuthSimple2State createState() => _PhoneAuthSimple2State();
}

class _PhoneAuthSimple2State extends State<PhoneAuthSimple2> {
    ...
    final PhoneVerificationCompleted verifiedSuccess = (FirebaseUser user) {
      ...
      setState(() {
        ...
        Future.delayed(Duration(seconds: 2), () {
          ...
          setState(() {
            showStatus = 3;
//                curruser.Mobile=savitem.Mobile;
//                curruser.Address=savitem.Address;
//                curruser.Pincode=savitem.Pincode;
//                curruser.key=user.uid;
          });
          Navigator.of(context).push(new MaterialPageRoute(
              builder: (BuildContext context) => new MyRequestsDisplay()));
        });
      });
    };
    ...
    if (showStatus == 3) {
      return CircularProgressIndicator(
          valueColor: new AlwaysStoppedAnimation<Color>(
              widget.progressIndicatorColor == null ? Colors.red : widget
